...
class MY_Email extends CI_Email {
     ...
     function config($data){
        $this->_mail=array(
                            "from_sender"       => "luckyluck379@gmail.com",
                            "name_sender"       => "Admin",
                            "subject_sender"    => "Mail from forum",
                         );
     ...
     function sendmail(){
            ...
            $config['smtp_user']    = 'luckyluck379@gmail.com'; // địa chỉ gmail
            $config['smtp_pass']    = 'minhthanh94'; // pass gmail
