...
<body>
	<div class="wrapper" id="info" page="userpage">
		<div class="header row container">
			...
			<div class="menu col-md-4 ">
				<ul class="nav nav-pills">
					...
					<?php echo "<li><a id=\"username\" value=\"".$persname."\">".$persname."</a></li>";?>
				...
				<div class="posts well well-lg" data-bind="attr: { pid: post_id }">
					<div class="row">
						<div class="userpost col-md-6">
							<a href="" data-bind="attr:{ href: username2}"><b data-bind="text: username2"></b></a>
						</div>						
						...
						<li>
							<div class="comment well well-sm" data-bind="attr: { cid: comment_id }">
								<div class="user-comment">
									<a href="" data-bind="attr:{ href: username}"><b data-bind="text: username"></b></a>
								</div>
